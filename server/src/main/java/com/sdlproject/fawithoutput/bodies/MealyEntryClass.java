...
import com.sdlproject.fawithoutput.mealy.MealyState;

import java.util.ArrayList;

public class MealyEntryClass {
    ...
    public ArrayList<MealyState> states;
    ...
    public void setStates(ArrayList<MealyState> states) {
        this.states = states;
    }

    public MealyEntryClass(String machine_name, FATypes machine_type, int input_alpha_count, ArrayList<InputSymbol> input_alpha, int output_alpha_count, ArrayList<OutputSymbol> output_alpha, int state_count, ArrayList<String> test_strings, ArrayList<MealyState> states) {
        this.machine_name = machine_name;
        this.machine_type = machine_type;
        this.input_alpha_count = input_alpha_count;
        this.input_alpha = input_alpha;
