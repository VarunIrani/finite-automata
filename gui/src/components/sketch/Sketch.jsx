...
class Sketch extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      deletedCount: 0,
      simulation: {machineType: null, show: false}
    }
  ...
  toggleSimulation(machineType) {
    const simulation = {machineType, show: !this.state.simulation.show}
  ...
  render() {
    ...
    return (
      <div>
        ...
        {this.state.simulation.show ?
          <SimulationModal machineType={this.state.simulation.machineType}
